        ...
        switch (state.currentMenu) {
          case "underwear":
            return MenuSidebar(
              ...
              itemsList: state.selectedItemsList,
              menuIcons: [binderIcon],
              menuNumber: 0,
            );
          case "tops":
            return MenuSidebar(
